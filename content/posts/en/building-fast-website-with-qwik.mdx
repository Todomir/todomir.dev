...
description: >-
  Discover how I leveraged the Qwik framework to build a high-performance,
  user-friendly website. Learn about Qwik's unique features, my development
  process, and the innovative techniques used for optimal web development.
...
tags:
  ...
  - web dev
  - performance
thumbnail: /assets/thumbnails/building-fast-website-with-qwik.png
thumbnailAlt: >-
  An astronaut swiftly flying through in space, with a bright pixel light source
  in the background
---
...
<Alert title="ATTENTION" severity="warning">
  ...
  cover the parts that I used to build my website, the problems I faced and how
  I solved them.
</Alert>
