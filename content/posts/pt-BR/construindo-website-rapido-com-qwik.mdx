...
thumbnailAlt: Um astronauta voando rapidamente pelo espaço, com uma intensa fonte de luz pixelizada ao fundo
tags:
  - qwik
  - desenvolvimento web
  - desempenho
...
<Alert severity="warning" title="ATENÇÃO">
  ...
  oficial](https://qwik.builder.io/docs/getting-started). Vou apenas abordar as
  partes que usei para construir meu site, os problemas que enfrentei e como os
  resolvi.
</Alert>
