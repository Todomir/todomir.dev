...
export default component$(() => {
  ...
  return (
    ...
    >
      ...
      <DvdScreensaver
        speedMultiplier={userPreferences.reducedMotion ? 0.1 : 1}
        class="pointer-events-none inline-flex flex-col items-center text-center"
      >
        <h1 class="text-7xl font-black italic" id="not-found-title">
          404
        </h1>
        <p
          id="not-found-description"
          class="mt-4 block max-w-sm text-balance text-2xl text-zinc-50"
        >
