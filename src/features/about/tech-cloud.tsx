...
export default component$(({ class: className }) => {
  const TECH = [
    "React",
    "Next.js",
    "JavaScript",
  ...
  return (
    ...
    >
      <ul class="motion-safe:animate-scroll animate-marquee flex min-w-full shrink-0 justify-around gap-8">
        {TECH.map((tech) => (
      ...
      <ul
        aria-hidden="true"
        class="motion-safe:animate-scroll animate-marquee flex min-w-full shrink-0 justify-around gap-8"
      >
        {TECH.map((tech) => (
          <Fragment key={tech + "--marquee"}>
