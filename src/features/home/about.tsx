  ...
  return (
    ...
    >
      <div class="flex flex-col gap-8 md:gap-20 lg:flex-row">
        <aside class="mt-10 ml-0 max-h-[600px] w-full grow overflow-hidden rounded-lg object-cover object-center">
          <ImgMe id="img-me" alt={t("home.about.meImageAlt")} />
        </aside>
        <article class="my-auto flex max-w-full flex-col gap-4">
          <h2
            class="text-3xl leading-10 font-medium tracking-tighter text-zinc-200 sm:text-[3rem]"
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            class="mt-12 max-w-full cursor-pointer text-xl leading-8 tracking-tight whitespace-nowrap text-zinc-500 underline md:text-2xl"
          >
