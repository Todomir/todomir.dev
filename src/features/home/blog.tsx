  ...
  return (
    ...
    >
      ...
      <a
        ...
        class="pointer-events-auto mt-10 mb-10 flex grow cursor-pointer items-stretch justify-end gap-2 self-end text-xl leading-7 tracking-tight whitespace-nowrap text-zinc-950 md:mt-16"
      >
